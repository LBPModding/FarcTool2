...
public class MiscUtils {
    ...
    public static String getEGUID(String fileGUID) {
        ...
        else if (thirdByte > 127 && thirdByte < 192)
            obfGUID += MiscUtils.leftPad(Integer.toHexString(((thirdByte * 2) - 128)), 2);
        else if (thirdByte > 191 && thirdByte < 256)
            obfGUID += MiscUtils.leftPad(Integer.toHexString(((thirdByte * 2) - 255)), 2);
